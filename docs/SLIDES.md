...
>
> **Final deck file:** [DefiNet-Defense-Deck.pptx](DefiNet-Defense-Deck.pptx) - 5 slides, English,
...
> Page 4: architecture. Page 5: key code samples. Every slide was verified by rendering it to an image and inspecting it.
